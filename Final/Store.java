...
public class Store
{
    ...
    {
        //Create a buisness customers
        Customer buisnessCustomer1 = FactoryPattern.getCustomer("Business1");
        this.Customers.add(buisnessCustomer1);
        Customer buisnessCustomer2 = FactoryPattern.getCustomer("Business2");
        this.Customers.add(buisnessCustomer2);
        Customer buisnessCustomer3 = FactoryPattern.getCustomer("Business3");
        this.Customers.add(buisnessCustomer3);
        Customer buisnessCustomer4 = FactoryPattern.getCustomer("Business4");
        this.Customers.add(buisnessCustomer4);

        //Create a casual customer
        Customer casualCustomer1 = FactoryPattern.getCustomer("Casual1");
        this.Customers.add(casualCustomer1);
        Customer casualCustomer2 = FactoryPattern.getCustomer("Casual2");
        this.Customers.add(casualCustomer2);
        Customer casualCustomer3 = FactoryPattern.getCustomer("Casual3");
        this.Customers.add(casualCustomer3);
        Customer casualCustomer4 = FactoryPattern.getCustomer("Casual4");
        this.Customers.add(casualCustomer4);

        //Create a regual customer
        Customer regulaCustomer1 = FactoryPattern.getCustomer("Regular1");
        this.Customers.add(regulaCustomer1);
        Customer regulaCustomer2 = FactoryPattern.getCustomer("Regular2");
        this.Customers.add(regulaCustomer2);
        Customer regulaCustomer3 = FactoryPattern.getCustomer("Regular3");
        this.Customers.add(regulaCustomer3);
        Customer regulaCustomer4 = FactoryPattern.getCustomer("Regular4");
        this.Customers.add(regulaCustomer4);
  }
